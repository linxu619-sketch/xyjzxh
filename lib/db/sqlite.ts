...
function seedNews(db: DB) {
  ...
  const rows: [string, string, string, string, string, number, string][] = [
    ["党建", "协会党支部召开「党建引领行业自律」主题党日活动", "全体党员重温入党誓词，围绕诚信经营与行业自律开展集中学习，号召党员企业亮身份、作表率，把党建优势转化为发展优势。", "协会党支部", "party", 1, "2026-05-26"],
    ["党建", "支部书记讲党课：把党的创新理论学习落到协会服务实务", "支部书记结合入会、报备、调解、集采等会员服务场景讲授专题党课，推动党员骨干在一线发挥先锋模范作用。", "协会党支部", "party", 0, "2026-05-18"],
    ["党建", "协会党支部组织党员赴鄂豫皖革命纪念馆开展红色教育", "通过现场参观与专题讨论，引导党员传承红色基因、坚定理想信念，凝聚行业高质量发展的奋进力量。", "协会党支部", "party", 0, "2026-04-30"],
