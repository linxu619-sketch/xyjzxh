...
/* 7 条非党建演示新闻的完整正文（Markdown）。
   既用于新库种子，也用于旧库幂等回填（旧库这些行此前只有「摘要+占位句」）。
   key 必须与下方 rows 的标题逐字一致。 */
const NEWS_FULL: Record<string, string> = {
  "关于发布《信阳市住宅装饰装修工程质量验收规范（2026版）》的通知":
`各会员单位、各从业人员：\n\n为进一步提升我市住宅装饰装修工程质量，规范施工与验收行为，经协会技术委员会组织专家修订、广泛征求意见，《信阳市住宅装饰装修工程质量验收规范（2026版）》现予发布，**自 2026 年 6 月 1 日起正式实施**。\n\n## 一、修订重点\n\n新版规范在原有基础上，重点强化了三个方面的标准：\n\n- **防水工程**：明确卫生间、厨房、阳台防水层闭水试验时间不少于 48 小时，并提高了防水返边高度要求；\n- **电气工程**：强调分回路设计与漏电保护，插座回路与照明回路必须分设，潮湿区域必须设置等电位联结；\n- **消防与材料**：明确装修材料燃烧性能等级要求，公共部位严禁使用不合格阻燃材料。\n\n## 二、贯彻要求\n\n1. 各会员单位应在**5 日内**组织管理与施工人员集中学习，并对照新规范完成在建项目的自查整改；\n2. 工装报备、竣工验收一律以新版规范为依据；\n3. 协会将不定期开展抽查，对不执行新规范的单位予以通报。\n\n规范全文及条文解读可在协会知识库下载。如有疑问，请联系协会技术委员会或咨询 AI 小协。\n\n信阳市建筑装饰装修协会\n2026 年 5 月 28 日`,

  "全省工装报备实现「一网通办」，信阳成为首批试点":
`近日，全省工装（公共建筑装饰装修）报备「一网通办」改革取得突破性进展，**信阳成为首批试点城市**。协会服务平台已与省厅监管系统完成对接，会员企业一次填报即可同步至省级监管，无需重复录入。\n\n## 改革带来的变化\n\n- **一次填报、多端同步**：企业在协会平台提交报备信息后，自动同步省厅系统，减少重复工作；\n- **进度可查**：报备受理、审核、办结全流程在线可视，企业随时掌握进度；\n- **材料精简**：通过数据共享，部分证照材料免于重复提交。\n\n据测算，新模式预计为企业**节约约 70% 的重复填报工时**，显著降低制度性交易成本。\n\n## 下一步\n\n协会将组织专场培训，指导会员企业熟悉新报备流程，并持续收集使用反馈，配合省厅优化系统功能。会员单位如在报备中遇到问题，可联系协会技术委员会获取一对一指导。`,

  "2026 信阳建博会启动报名 — AI 与绿色建造成主题":
`2026 信阳建筑装饰博览会现已启动报名，本届展会以「**AI 与绿色建造**」为主题，聚焦智能装修、低碳建材与数字化设计等行业前沿方向。\n\n## 展会亮点\n\n- **协会专属展区**：为会员企业集中设置专属展区，统一形象、集中引流；\n- **会员专享优惠**：会员企业享受**5 折展位**优惠，名额有限、先到先得；\n- **AI 装修体验馆**：新增 AI 装修体验馆，现场演示 AI 估价、智能设计、虚拟样板间等应用。\n\n## 报名方式\n\n有意参展的会员单位请于报名截止日期前，通过协会平台或联系会员服务部提交参展申请。展位按报名顺序与会员等级综合分配，敬请尽早报名。\n\n协会将为参展会员提供布展指导、宣传推广等一站式服务，助力企业借展会拓展商机。`,

  "5 月 30 日 · 协会高级会员季度交流会":
`协会高级会员季度交流会将于 **5 月 30 日** 在协会四楼大会议室举行，诚邀各高级会员企业负责人参加。\n\n## 本期主题\n\n**AI 在装修营销中的落地** —— 围绕如何用 AI 工具提升获客效率、优化客户沟通、辅助方案设计等实务话题展开分享与研讨。\n\n## 议程安排\n\n- 主题分享：AI 营销工具的实战应用；\n- 案例交流：会员企业落地经验分享；\n- 自由研讨：经营难点答疑与资源对接。\n\n## 参会方式\n\n请拟参会的高级会员于会前通过会员服务部确认席位。交流会为高级会员专属权益，名额有限。期待与各位共话行业趋势、共谋发展。`,

  "华泰建工承建的茶博园景观二期工程顺利封顶":
`近日，由协会会员单位**华泰建工**承建的茶博园景观二期工程顺利封顶，标志着该绿色建造一体化样板项目取得阶段性成果。\n\n## 项目特色\n\n本项目在材料与工艺上践行绿色低碳理念：\n\n- 采用**低碳混凝土**，有效降低单方碳排放；\n- 创新使用**本地茶叶残渣再生骨料**，实现地方资源循环利用；\n- 推行绿色建造一体化管理，统筹设计、施工与材料供应。\n\n## 示范意义\n\n项目将绿色建造理念贯穿全过程，为我市装饰装修与景观工程提供了可复制、可推广的低碳样板。协会将持续挖掘会员单位优秀实践，推动行业向绿色化、工业化方向转型升级。`,

  "财政部、住建部联合发文，家装质保险纳入消费券支持范围":
`财政部、住建部近日联合发文，明确将**家装质量保证保险纳入消费券支持范围**，进一步保障消费者家装权益、释放装修消费潜力。**信阳率先试点**这一政策。\n\n## 业主可享什么\n\n- 业主购买**协会版安心家装险**，可叠加 **100 元消费券**；\n- 投保后，装修过程中的质量风险由保险机制兜底，理赔有据可依；\n- 协会版产品经统一遴选，条款清晰、理赔便捷。\n\n## 政策意义\n\n家装质保险与消费券叠加，既降低了业主的投保成本，又以保险机制倒逼施工质量提升，形成「**消费者放心、企业守信、行业提质**」的良性循环。\n\n有意投保的业主可通过协会平台保险专区了解产品详情，或咨询协会金融保险委员会。`,

  "2026 第二批会员入会公示（共 23 家）":
`根据协会章程及入会审核程序，经申请单位提交材料、秘书处初审、理事会审议，现将 **2026 年第二批拟入会会员名单（共 23 家）** 予以公示。\n\n## 公示事项\n\n- **公示期为 7 天**，自本公告发布之日起计算；\n- 公示期内，如对拟入会单位的资质、经营、信用等情况有异议，可向协会反映；\n- 反馈渠道：通过协会秘书处或 AI 小协提交，反映情况应客观真实、便于核查。\n\n## 后续安排\n\n公示期满无异议或异议不成立的，按程序办理入会手续、颁发会员证书。协会将持续严把入会关，吸纳守法经营、诚信履约的优质单位加入，共同维护行业秩序、提升行业形象。\n\n感谢各界监督。`,
};

function seedNews(db: DB) {
  if (!isEmpty(db, "news")) return;
  // [category, title, excerpt, author, color, hot, date, body?]
  // 党建动态全文（真实党建报道体，非占位）
  const PB_DANGRI =
    "为深入学习贯彻习近平新时代中国特色社会主义思想，扎实推进行业党建工作，近日，中国共产党信阳市建筑装饰装修协会支部委员会组织全体党员开展「党建引领行业自律」主题党日活动。\n\n活动伊始，全体党员面向党旗肃立，重温入党誓词，铿锵誓言彰显共产党员对党忠诚的政治本色。随后，支部围绕诚信经营与行业自律开展集中学习，结合建筑装饰装修行业实际，引导党员企业带头守法经营、守约履约、保证工程质量，自觉抵制低价恶性竞争和偷工减料等行为。\n\n支部要求，全体党员要亮身份、当先锋、作表率，把党建优势转化为发展优势，带动广大会员单位诚信兴业，以高质量党建引领信阳建筑装饰装修行业高质量发展。";
  const PB_DANGKE =
    "为推动党的创新理论入脑入心、见行见效，近日，中国共产党信阳市建筑装饰装修协会支部委员会开展专题党课，由支部书记以《把党的创新理论学习落到协会服务实务》为题为全体党员授课。\n\n党课紧扣习近平新时代中国特色社会主义思想，系统宣讲党的二十大精神，并结合协会入会审核、工装报备、建材集采、纠纷调解、教育培训等会员服务场景，深入讲解如何把理论学习成果转化为服务会员、服务行业的务实举措。\n\n党课要求，党员骨干要做到学思用贯通、知信行统一，在服务一线当先锋、作表率，以学习成效推动协会服务提质、会员发展增效。";
  const PB_REDU =
    "为传承红色基因、坚定理想信念，近日，中国共产党信阳市建筑装饰装修协会支部委员会组织全体党员赴鄂豫皖革命纪念馆开展红色教育主题党日活动。\n\n党员们怀着崇敬之情参观革命历史陈列，透过一件件珍贵文物、一幅幅历史照片，重温大别山「二十八年红旗不倒」的光辉历程，深切感悟革命先辈坚定信念、不怕牺牲、勇于奉献的崇高精神。\n\n大家纷纷表示，要从党的百年奋斗历程中汲取奋进力量，立足建筑装饰装修行业岗位，发挥党员先锋模范作用，以实际行动践行初心使命，为行业高质量发展贡献力量。";
  // 理论学习（真实学习材料）
  const TL_XJP =
    "习近平新时代中国特色社会主义思想是党的十九大确立的党必须长期坚持的指导思想，是当代中国马克思主义、二十一世纪马克思主义，是中华文化和中国精神的时代精华。\n\n这一思想科学回答了新时代坚持和发展什么样的中国特色社会主义、怎样坚持和发展中国特色社会主义等重大时代课题。全体党员要深刻领悟「两个确立」的决定性意义，增强「四个意识」、坚定「四个自信」、做到「两个维护」。\n\n支部将持续组织党员原原本本学、联系实际学，做到学懂弄通做实，把学习成效转化为服务会员、服务行业的实际行动。";
  const TL_ERSHIDA =
    "中国共产党第二十次全国代表大会的主题是：高举中国特色社会主义伟大旗帜，全面贯彻习近平新时代中国特色社会主义思想，弘扬伟大建党精神，自信自强、守正创新，踔厉奋发、勇毅前行，为全面建设社会主义现代化国家、全面推进中华民族伟大复兴而团结奋斗。\n\n大会强调，从现在起，中国共产党的中心任务就是团结带领全国各族人民全面建成社会主义现代化强国、实现第二个百年奋斗目标，以中国式现代化全面推进中华民族伟大复兴。\n\n支部号召全体党员深刻领会党的二十大精神，立足建筑装饰装修行业岗位，在推动行业高质量发展中践行使命担当。";
  const TL_DANGZHANG =
    "《中国共产党章程》是党的根本大法，是全党必须遵循的总规矩，规定了党的性质宗旨、指导思想、奋斗目标，规定了党员的义务和权利、党的组织制度和纪律。\n\n每一名党员都要把学习党章作为必修课，认真学习《中国共产党纪律处分条例》等党内法规，严守政治纪律和政治规矩，知敬畏、存戒惧、守底线，永葆共产党人清正廉洁的政治本色。\n\n支部将把学习党章党规与日常组织生活相结合，引导党员以更高标准要求自己，发挥先锋模范作用。";
  const rows: [string, string, string, string, string, number, string, string?][] = [
    ["党建", "协会党支部召开「党建引领行业自律」主题党日活动", "全体党员重温入党誓词，围绕诚信经营与行业自律开展集中学习，号召党员企业亮身份、作表率，把党建优势转化为发展优势。", "协会党支部", "party", 1, "2026-05-26", PB_DANGRI],
    ["党建", "支部书记讲党课：把党的创新理论学习落到协会服务实务", "支部书记结合入会、报备、调解、集采等会员服务场景讲授专题党课，推动党员骨干在一线发挥先锋模范作用。", "协会党支部", "party", 0, "2026-05-18", PB_DANGKE],
    ["党建", "协会党支部组织党员赴鄂豫皖革命纪念馆开展红色教育", "通过现场参观与专题讨论，引导党员传承红色基因、坚定理想信念，凝聚行业高质量发展的奋进力量。", "协会党支部", "party", 0, "2026-04-30", PB_REDU],
    ["理论学习", "学习贯彻习近平新时代中国特色社会主义思想", "习近平新时代中国特色社会主义思想是当代中国马克思主义、二十一世纪马克思主义，是全党全国人民实现中华民族伟大复兴的行动指南。", "协会党支部", "party", 1, "2026-05-22", TL_XJP],
    ["理论学习", "深入学习宣传贯彻党的二十大精神", "党的二十大擘画了全面建成社会主义现代化强国、以中国式现代化全面推进中华民族伟大复兴的宏伟蓝图。", "协会党支部", "party", 0, "2026-05-12", TL_ERSHIDA],
    ["理论学习", "学习《中国共产党章程》，知规明矩守纪律", "党章是党的根本大法，是全党必须遵循的总规矩。学习党章、遵守党章、贯彻党章、维护党章，是加强党的建设的基础性工程。", "协会党支部", "party", 0, "2026-05-06", TL_DANGZHANG],
  ...
  for (const r of rows) {
    const content = r[7] ?? NEWS_FULL[r[1]] ?? `${r[2]}\n\n本文由${r[3]}发布，详情以协会正式通知为准。会员单位如有疑问可联系协会秘书处或咨询 AI 小协。`;
...
function backfillPractitionerTiers(db: DB) {
  ...
  const J: [string, number, number, number, number, number][] = [
    ["急招水电工 5 名 · 金茂悦府工地", 420, 18, 50, 2, 1],
    ["木工 3 名 · 全屋定制安装", 480, 18, 55, 3, 0],
    ["土建项目经理 1 名", 1000, 28, 55, 5, 1],
    ["油漆工 4 名 · 茶都商务办公装修", 400, 18, 55, 0, 0],
...
function migrate(db: DB) {
  const alters = [
    ...
    "ALTER TABLE jobs ADD COLUMN gender_req TEXT",
    "ALTER TABLE jobs ADD COLUMN need_cert INTEGER",
  ...
  // 旧库演示新闻只有「摘要+占位句」当正文：用完整范文回填（仅改仍是占位的行，不动已编辑/党建全文）
  // 占位句历史上有两种措辞，统一用「示例正文」这一标记匹配，确保只命中未编辑的演示行。
  try {
    const up = db.prepare("UPDATE news SET content=? WHERE title=? AND (content LIKE '%示例正文%' OR content LIKE '%详情以协会正式通知为准%')");
    for (const [title, body] of Object.entries(NEWS_FULL)) up.run(body, title);
  } catch { /* 表不存在则忽略 */ }
}
