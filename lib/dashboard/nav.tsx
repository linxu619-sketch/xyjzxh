import {
  ...
  Hammer, ShoppingBag, Truck, FileSignature, GraduationCap, Store, UserCog, Receipt, Coins, Flag,
} from "lucide-react";
...
export const ASSOC_NAV: AssocNavItem[] = [
  ...
  { href: "/dashboard/association/users",      label: "会员管理", icon: <UserCog className={I} />,              perm: "users" },
  ...
  { href: "/dashboard/association/cpc",         label: "党的建设", icon: <Flag className={I} />,                 perm: "party" },
...
export const ENT_NAV = [
  ...
  { href: "/dashboard/enterprise/recruit",  label: "招聘岗位",   icon: <Briefcase className={I} /> },
  { href: "/dashboard/enterprise/jobs",     label: "用工派单",   icon: <Hammer className={I} /> },
