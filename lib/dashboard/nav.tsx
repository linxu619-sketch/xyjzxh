...
export const ASSOC_NAV = [
  ...
  { href: "/dashboard/association/members",    label: "会员审核", icon: <Users2 className={I} />, badge: "7" },
  { href: "/dashboard/association/reports",    label: "工装报备", icon: <FileCheck2 className={I} />, badge: "12" },
  { href: "/dashboard/association/mediations", label: "调解纠纷", icon: <MessageSquareWarning className={I} />, badge: "3" },
...
export const ENT_NAV = [
  ...
  { href: "/dashboard/enterprise/leads",    label: "客户线索",   icon: <MessagesSquare className={I} />, badge: "5" },
  { href: "/dashboard/enterprise/orders",   label: "施工订单",   icon: <Hammer className={I} />, badge: "6" },
  { href: "/dashboard/enterprise/projects", label: "项目与报备", icon: <FileCheck2 className={I} />, badge: "2" },
